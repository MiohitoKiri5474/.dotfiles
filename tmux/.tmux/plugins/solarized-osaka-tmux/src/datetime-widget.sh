...
SHOW_DATETIME=$(tmux show-option -gv @solarized-osaka-tmux_show_datetime 2>/dev/null)
...
date_format=$(tmux show-option -gv @solarized-osaka-tmux_date_format 2>/dev/null)
time_format=$(tmux show-option -gv @solarized-osaka-tmux_time_format 2>/dev/null)
